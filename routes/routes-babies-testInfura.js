...
var abi = [
    {
        ...
        inputs: [
            ...
            { name: "_babyHashFingerprint", type: "uint256" },
            { name: "_motherHashFingerprint", type: "uint256" },
            { name: "_motherName", type: "string" },
            { name: "_hospitalAddress", type: "address" },
            { name: "_genero", type: "uint8" },
    ...
    },
    {
        ...
        outputs: [
            ...
            { name: "motherHashFingerprint", type: "uint256" },
            { name: "motherName", type: "string" },
            { name: "hospitalAddress", type: "address" },
            { name: "genero", type: "uint8" },
            { name: "birthDay", type: "uint256" },
    ...
    {
        constant: true,
        inputs: [{ name: "_babyHashFingerprint", type: "uint256" }],
...
var appRouter = function (app) {
    ...
    app.post("/API/babies/register/", function (req, res) {
        ...
        var sendPromise = contract_sign.registerBaby(
            strRegisteredName,
            uintBabyHashFingerprint,
            uintMotherHashFingerprint,
            strMotherName,
            addrhospitalAddress,
            uintGenero,
            uintBirthDay
